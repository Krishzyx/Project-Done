<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:zudocart@gmail.com"><i class="fas fa-envelope"></i> @zudocart</a>
         <a href="https://www.google.com/myplace"><i class="fas fa-map-marker-alt"></i> Lucknow, Uttar Pradesh </a>
      </div>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Zudocart</span> | all rights reserved!</div>
